...
U32		NX_CLKPWR_GetInterruptEnable32( void )
{
	...
	return (U32)((ReadIO32(&__g_pRegister->GPIOINTENB) & GPIOENB_MASK) 
		| ((ReadIO32(&__g_pRegister->INTENABLE) & ENB_MASK)<<9));
}
...
CBOOL	NX_CLKPWR_GetInterruptEnableAll( void )
{
	...
	if( (ReadIO32(&__g_pRegister->GPIOINTENB) & GPIOINTENB_MASK) 
		|| (ReadIO32(&__g_pRegister->INTENABLE) & INTENB_MASK) )
	{
		return CTRUE;
	}
