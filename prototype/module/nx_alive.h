...
struct NX_ALIVE_RegisterSet
{
	...
	volatile U32 CLEARWAKEUPSTATUS      ;   ///< 0x0A4 :  wCS[41]
	volatile U32 WAKEUPSTATUS           ;   ///< 0x0A8 :  wCS[42]

	volatile U32 ALIVESCRATCHRST1       ;   ///< 0x0AC :  wCS[43]
	volatile U32 ALIVESCRATCHSET1       ;   ///< 0x0B0 :  wCS[44]
	volatile U32 ALIVESCRATCHVALUE1     ;   ///< 0x0B4 :  wCS[45]

	volatile U32 ALIVESCRATCHRST2       ;   ///< 0x0B8 :  wCS[46]
	volatile U32 ALIVESCRATCHSET2       ;   ///< 0x0BC :  wCS[47]
	volatile U32 ALIVESCRATCHVALUE2     ;   ///< 0x0C0 :  wCS[48]

	volatile U32 ALIVESCRATCHRST3       ;   ///< 0x0C4 :  wCS[49]
	volatile U32 ALIVESCRATCHSET3       ;   ///< 0x0C8 :  wCS[50]
	volatile U32 ALIVESCRATCHVALUE3     ;   ///< 0x0CC :  wCS[51]

	volatile U32 ALIVESCRATCHRST4       ;   ///< 0x0D0 :  wCS[52]
	volatile U32 ALIVESCRATCHSET4       ;   ///< 0x0D4 :  `wCS[53]
	volatile U32 ALIVESCRATCHVALUE4     ;   ///< 0x0D8 :  wCS[54]

	volatile U32 ALIVESCRATCHRST5       ;   ///< 0x0DC :  wCS[55]
	volatile U32 ALIVESCRATCHSET5       ;   ///< 0x0E0 :  wCS[56]
	volatile U32 ALIVESCRATCHVALUE5     ;   ///< 0x0E4 :  wCS[57]

	volatile U32 ALIVESCRATCHRST6       ;   ///< 0x0E8 :  wCS[58]
	volatile U32 ALIVESCRATCHSET6       ;   ///< 0x0EC :  wCS[59]
	volatile U32 ALIVESCRATCHVALUE6     ;   ///< 0x0F0 :  wCS[60]

	volatile U32 ALIVESCRATCHRST7       ;   ///< 0x0F4 :  wCS[61]
	volatile U32 ALIVESCRATCHSET7       ;   ///< 0x0F8 :  wCS[62]
	volatile U32 ALIVESCRATCHVALUE7     ;   ///< 0x0FC :  wCS[63]

	volatile U32 ALIVESCRATCHRST8       ;   ///< 0x100 :  wCS[64]
	volatile U32 ALIVESCRATCHSET8       ;   ///< 0x104 :  wCS[65]
	volatile U32 ALIVESCRATCHVALUE8     ;   ///< 0x108 :  wCS[66]

	volatile U32 VDDOFFCNTVALUERST      ;   ///< 0x10C :  wCS[67]
	volatile U32 VDDOFFCNTVALUESET      ;   ///< 0x110 :  wCS[68]

	volatile U32 VDDOFFCNTVALUE0        ;   ///< 0x114 :  wCS[69]
	volatile U32 VDDOFFCNTVALUE1        ;   ///< 0x118 :  wCS[70]

	volatile U32 ALIVEGPIOINPUTVALUE;       ///< 0x11C :  wCS[71]
