...
#define NX_BASE_ADDR_IOPERI_QOS_TRDMARK     (NX_VA_BASE_REG_PL301_IOPERI + NX_PL301_QOS_TRDMARK_OFFSET)
#define NX_BASE_ADDR_IOPERI_QOS_CTRL        (NX_VA_BASE_REG_PL301_IOPERI + NX_PL301_QOS_CTRL_OFFSET)
#define NX_BASE_ADDR_IOPERI_AR              (NX_VA_BASE_REG_PL301_IOPERI + NX_PL301_AR_OFFSET)
#define NX_BASE_ADDR_IOPERI_AW              (NX_VA_BASE_REG_PL301_IOPERI + NX_PL301_AW_OFFSET)
...
#define NX_BASE_ADDR_SFR_QOS_TRDMARK        (NX_VA_BASE_REG_PL301_SFR + NX_PL301_QOS_TRDMARK_OFFSET)
#define NX_BASE_ADDR_SFR_QOS_CTRL           (NX_VA_BASE_REG_PL301_SFR + NX_PL301_QOS_CTRL_OFFSET)
...
#define NX_BASE_ADDR_STATIC_QOS_TRDMARK     (NX_VA_BASE_REG_PL301_STATIC + NX_PL301_QOS_TRDMARK_OFFSET)
#define NX_BASE_ADDR_STATIC_QOS_CTRL        (NX_VA_BASE_REG_PL301_STATIC + NX_PL301_QOS_CTRL_OFFSET)
#define NX_BASE_ADDR_STATIC_AR              (NX_VA_BASE_REG_PL301_STATIC + NX_PL301_AR_OFFSET)
#define NX_BASE_ADDR_STATIC_AW              (NX_VA_BASE_REG_PL301_STATIC + NX_PL301_AW_OFFSET)
